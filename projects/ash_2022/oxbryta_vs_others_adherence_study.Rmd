...
colnames(table1$tbl_bal) <- paste0(stringr::str_to_title(colnames(table1$tbl_bal)), "\n", table1$tbl_bal[1,])
table1$tbl_bal[,1] <- 
...
final_model_tbl$Covariate <- 
  c("Intercept",
    "Age 12-19", "Age 20-29", "Age 30-49", "Age 50+",
    "Gender Male",
    ...
    "VOC (Inpatient) 2",
    "VOC (Inpatient) 3+",
    "VOC (Emergency Room) 1",
    "VOC (Emergency Room) 2",
    "VOC (Emergency Room) 3+"
    )
